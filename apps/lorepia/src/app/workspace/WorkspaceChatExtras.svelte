<script lang="ts">
    ...
    import GenerationAttemptApprovals from './runtime/GenerationApprovals.svelte';
    import MemoryQueryRetryPanel from './runtime/MemoryRetries.svelte';
    import { InteractionRoomLifecycle } from '../../features/chat/interaction-room-lifecycle.svelte';
    import InteractionRoomSurface from './runtime/InteractionSurface.svelte';
    let {
        appState,
        controller,
        client,
