...
describe('live workspace chat bridge', () => {
    ...
    it('projects verified streaming state once and keeps stored message metadata', async () => {
        ...
        state.chat.streaming_text = '검증된 스트림';
