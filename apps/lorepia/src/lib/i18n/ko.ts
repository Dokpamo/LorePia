...
export const ko = {
    ...
    'chat.message.remove_confirm': '제거 확인',
    'chat.message.remove_from_here': '여기부터 제거',
    ...
    'chat.runtime.capability.callbacks': '카드 콜백 실행',
    'chat.runtime.capability.chat_read': '현재 대화 읽기',
    'chat.runtime.capability.chat_write': '표시 메시지와 전송 흐름 변경',
    'chat.runtime.capability.elevated': '고급 카드 권한',
    'chat.runtime.capability.lore_read': '활성 로어북 읽기',
    'chat.runtime.capability.model_auxiliary': '선택한 보조 모델 호출',
    'chat.runtime.capability.model_primary': '현재 기본 모델 호출',
    'chat.runtime.capability.profile_read': '캐릭터·페르소나 정보 읽기',
    'chat.runtime.capability.state_readwrite': '카드별 상태 저장',
    'chat.runtime.capability.ui_write': '카드 UI·배경·알림 표시',
    'chat.runtime.cancel.unconfirmed':
        '중지를 요청했지만 종료를 확인하지 못했습니다. 다시 시도할 수 있습니다.',
    'chat.runtime.event_timeout': '캐릭터 기능 실행 시간이 초과되어 안전하게 중지했습니다.',
    'chat.runtime.execution_failed': '캐릭터 기능을 실행하지 못했습니다.',
    'chat.runtime.not_ready': '캐릭터 런타임이 준비되지 않았습니다.',
    'chat.runtime.option_failed': '카드 옵션을 변경하지 못했습니다.',
    'chat.runtime.permissions.approve_selected': '선택한 기능만 이번 세션에서 허용',
    'chat.runtime.permissions.sensitive':
    ...
    'interaction.surface.approval_expires': '{seconds}초 안에 결정',
    'interaction.surface.asset_alt': '{region} 상호작용 미디어',
    'interaction.surface.asset_label': '{region} 미디어',
    'interaction.surface.audio': '상호작용 오디오',
    'interaction.surface.choice_expired': '이 선택지는 만료되었습니다.',
    'interaction.surface.choice_selected': '선택 반영됨: {choice}',
    'interaction.surface.choices': '선택지',
    'interaction.surface.dice': '주사위 {count}d{sides}{modifier} → {rolls} · 합계 {total}',
    'interaction.surface.expired_more':
        '만료된 승인 제안이 더 남아 있습니다. 최신 상태를 모두 정리하기 전에는 다른 제안을 결정할 수 없습니다.',
    'interaction.surface.expired_more_action': '만료 제안 계속 정리',
    'interaction.surface.loading': '대화 상호작용을 복원하는 중입니다.',
    'interaction.surface.older_effects':
        '이전 상호작용 기록은 전문가 기록 화면에서 확인할 수 있습니다.',
    'interaction.surface.projection.asset_unavailable':
        '저장된 미디어 효과를 현재 사용할 수 없어 숨겼습니다.',
    'interaction.surface.projection.incompatible': '호환되지 않는 저장 효과를 숨겼습니다.',
    'interaction.surface.projection.unsafe_text':
        '안전한 표시 범위를 벗어난 저장 효과를 숨겼습니다.',
    'interaction.surface.proposals': '승인 대기 제안',
    'interaction.surface.revision': '상태 revision {revision}',
    'interaction.surface.title': '대화 상호작용',
    'interaction.surface.unknown': '알 수 없음',
