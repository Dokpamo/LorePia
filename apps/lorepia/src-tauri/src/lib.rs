...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            module_lifecycle_commands::review_content_module_activation_page,
            module_lifecycle_commands::resolve_content_module_activation_summary,
            module_lifecycle_commands::activate_content_module_summary,
