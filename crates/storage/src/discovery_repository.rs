...
use lorepia_domain::{
    ...
    discovery::{
        ...
        DiscoveryCompensationTarget, DiscoveryEffect, DiscoveryEventId,
...
use contract_codec::{
    ...
    encode_redacted_json, enum_wire_result, looks_like_secret, parse_approval_decision,
    parse_discovery_state, parse_operation_kind, parse_side_effect_class, parse_timestamp,
    require_session, sha256_hex, validate_approval_references,
    ...
    validate_session_evidence_ids, validate_sha256,
};
