...
use retryable_projection::retryable_generation_attempt_projection;
...
impl Storage {
    ...
    fn prepare_generation_attempt_observed(
        ...
        let verified_module_import_authorities =
            crate::orchestration::verify_module_import_authorities(
                self,
                &module_runtime_review.ordered_bindings,
            )?;
        ...
        crate::orchestration::validate_fresh_module_merge_review(
            ...
            &verified_module_import_authorities,
        )?;
