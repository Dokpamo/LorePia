...
pub use generation::{
    ConnectionBoundCredential, GenerationCredentialAdmissionLease, GenerationOperationContext,
...
use generation::{
    ...
    same_branch_generation_semantic_fingerprint, validate_connection_credential_binding,
