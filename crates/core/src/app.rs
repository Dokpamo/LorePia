...
use lorepia_domain::{
    ...
    VariableMap, prompt_local_user_id_sha256, validate_opaque_reasoning_states,
};
#[cfg(test)]
use lorepia_domain::{ModelAvailability, ParameterId, ParameterType, UiParameterLevel};
#[cfg(test)]
use lorepia_providers::OPAQUE_REASONING_STATE_UNSUPPORTED_ERROR;
#[cfg(test)]
use lorepia_providers::parameter_mapping::GEMINI_OPAQUE_REASONING_TOPOLOGY_ERROR;
use lorepia_providers::parameter_mapping::{
    OpenRouterReasoningWireStyle, ParameterEngine, PromptCacheWireDialect, ReasoningWireDialect,
};
...
use lorepia_providers::{
    ...
    ModelListResult, ModelRecordSource, OpenAiCompatibleProvider, OpenRouterReasoningEffortSupport,
    OpenRouterSupportedParameter, OpenRouterSupportedParameterSupport, Provider, ProviderEvent,
...
use generation::{
    ...
    ResolvedGenerationOperationIdentity, SameBranchGenerationAttemptIdentity,
    ValidatedGenerationTarget, build_resolved_generation_target, effective_capability_at,
    effective_route_parameter_specs, generation_action_name, generation_target_provider_authority,
    ...
    require_generation_provider_target_authority, same_branch_generation_semantic_fingerprint,
    validate_capability_wire_metadata, validate_connection_credential_binding,
    validate_generation_preset_candidate_plan, validate_generation_target_for_attempt,
