...
pub(crate) use generation::{
    ...
    configure_generation_protocol_request, prompt_route_supports_temperature,
...
use generation::{
    ...
    ResolvedGenerationOperationIdentity, ReviewedPromptSendContext,
    SameBranchGenerationAttemptIdentity, ValidatedGenerationTarget, effective_capability_at,
    ...
    same_branch_generation_semantic_fingerprint, snapshot_provider_request,
