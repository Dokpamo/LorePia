...
use chrono::Utc;
use lorepia_domain::{
    ApiFamily, AuxiliaryTaskKind, ConversationBranchId, ConversationId, CoreError, CoreErrorCode,
    CoreResult, GenerationId, InteractionAction, InteractionEffect, InteractionEvent,
    InteractionProposalDecision, InteractionProposalRecord, InteractionProposalRecordId,
    InteractionProposalStatus, InteractionRule, InteractionRuleId, InteractionState, MemoryJob,
    MemoryJobId, MemoryJobKind, MemoryJobStatus, MemoryProfile, MemoryRecord, MessageId,
    ModelAvailability, ModelRouteId, ProviderConnection, Sha256Digest, TaskProfile,
...
use lorepia_orchestration::{
    ...
    MemoryJobKeyInput, MemorySemanticScore, ModuleMergeReview, decide_pending,
...
use lorepia_storage::{
    ...
    MemoryEmbeddingRecord, MemoryJobFinish, MemoryJobInterruption, MemoryQueryEmbeddingIntent,
    MemoryQueryEmbeddingStatus, ObjectRevision, RetryableGenerationAttemptProjection,
...
use self::auxiliary_tasks::{
    MemorySummaryHeadAuthority, ResolvedPromptRuntimePolicy, claimed_memory_job,
    memory_execution_without_record, memory_job_error, memory_job_id_from_key,
    queue_entry_as_revisioned,
};
#[cfg(test)]
...
use crate::{
    Core, InteractionChoiceSelectionReceipt, Revisioned,
    app::generation_attempt_module_authority,
