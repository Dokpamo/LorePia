...
use lorepia_domain::{
    ...
    InteractionProposalRecordId, InteractionProposalStatus, InteractionState, Sha256Digest,
...
use lorepia_storage::{
    ...
    GenerationAttemptStatus, InteractionDerivedEventCommit, InteractionKnowledgeBinding,
    InteractionProposalApprovalCommit, InteractionProposalRejectionCommit,
    RetryableGenerationAttemptProjection, StoredGenerationAttemptProposal,
    StoredInteractionProposal, interaction_proposal_review_sha256,
};
