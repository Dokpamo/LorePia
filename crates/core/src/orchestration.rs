...
use lorepia_domain::{
    ...
    ConversationMode, InteractionRuleSet, InteractionRuleSetId, KnowledgeBook, KnowledgeEntryId,
    MemoryProfile, Message, MessageId, MessageRole, ModuleBinding, ModuleBindingId,
    ModuleComponentRef, ModuleScope, OverflowTrace, PersonaId, PromptContextBindingEvidence,
    ...
    SemanticKnowledgeScore, SourceKind, TransformSet, TransformSetId, VariableMap, VersionedJson,
    prompt_context_snapshot_sha256, prompt_local_user_id_sha256,
};
use lorepia_orchestration::{
    AppliedModuleRuntimePlan, KnowledgeWorkBudget, ModuleResolutionContext, TransformResult,
...
use lorepia_storage::{
    ContentModuleRevisionDiff, GenerationPromptPlanRecord, GenerationPromptSelectionAuthority,
    GenerationProviderTargetAuthority, InteractionKnowledgeBinding, KnowledgeActivationLog,
    KnowledgeEmbeddingMatch, ModuleRevisionComponentSnapshot, ObjectRevision, PromptPresetBinding,
