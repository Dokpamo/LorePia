...
use lorepia_orchestration::{
    AppliedModuleRuntimePlan, ApprovedModuleActivationPlan, ApprovedModuleRollbackPlan,
    IgnoredModuleBindingReason, ModuleActivationApproval, ModuleActivationPlan,
    ModuleActivationReview, ModuleCandidateSource, ModuleImportApprovalEvidence,
    ModuleImportComponentAuthority, ModuleMergeError, ModuleMergeResolutionSet,
    ModuleResolutionContext, ModuleRevisionSnapshot, ModuleRollbackPlan, ModuleRollbackPolicy,
    ModuleRollbackReview, PackageComponentKind, approve_module_activation_plan,
    approve_module_rollback_plan, prepare_module_rollback, resolve_module_merge,
    review_module_activation, review_module_merge, review_module_rollback,
};
use lorepia_storage::{
    ActiveContentModuleRevision, CompletedPackageAuthority, ModuleRevisionComponentSnapshot,
    PackageImportStatus, StoredRevision,
};
...
struct PreparedModuleRuntimeReview {
    review: ModuleActivationReview,
    bindings: Vec<(StoredRevision<ModuleBinding>, ModuleBinding)>,
}
...
impl Core {
    ...
    fn prepare_current_content_module_runtime(
        &self,
        context: &ModuleResolutionContext,
    ...
    fn module_snapshot_for_binding(
        &self,
...
fn content_module_runtime_binding_summary(
